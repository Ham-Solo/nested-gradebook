...
Grade.create(score: 75 , assignment_id: Assignment.find_by_name('HW Assignment #4').id, student_id: Student.find_by_name('Tristan Bazemore').id )
...
Grade.create(score: 56, assignment_id: Assignment.find_by_name('HW Assignment #4').id, student_id: Student.find_by_name('Tristan Bazemore').id )
